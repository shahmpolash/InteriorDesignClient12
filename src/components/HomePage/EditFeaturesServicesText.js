...
const EditFeaturesServicesText = () => {
    ...
    useEffect(() => {
        fetch(`https://interiordesignseoclone-610277fa395f.herokuapp.com/featurestext/${id}`)
            .then((res) => res.json())
    ...
    const handleFeaturesTextSection = (event) => {
        ...
        const url = `https://interiordesignseoclone-610277fa395f.herokuapp.com/featurestext/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                        ...
                        <form class="contact-form " onSubmit={handleFeaturesTextSection}>
                            <div class="row">
                                ...
                                <div class="slider-btn">
                                    <button className="thm-btn" data-animation="fadeInRight" data-delay=".8s"> Update Features Text </button>
                                </div>
                            </div>
