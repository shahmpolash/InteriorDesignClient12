...
const FeaturesServicesAdd = () => {
    ...
    useEffect(() => {
        fetch(`https://interiordesignseoclone-610277fa395f.herokuapp.com/featurestext`)
            .then((res) => res.json())
            .then((info) => setFeaturesText(info));
    }, []);

    useEffect(() => {
        fetch(`https://interiordesignseoclone-610277fa395f.herokuapp.com/featureitems`)
            .then((res) => res.json())
    ...
    const handleFeaturesTextSection = (event) => {
        ...
        const url = `https://interiordesignseoclone-610277fa395f.herokuapp.com/add-feature-text`;
        fetch(url, {
            method: "POST",
            headers: {
    ...
    const handleItemSection = (event) => {
        ...
        const url = `https://interiordesignseoclone-610277fa395f.herokuapp.com/add-feature-Item`;
        fetch(url, {
            method: "POST",
            headers: {
                "content-type": "application/json",
                            ...
                            <div class="col-lg-8 col-md-12">
                                ...
                                <h3 className='mt-5'> Update Features Services Text </h3>
                                {
                                    ...
                                    <>
                                        {featurestext.map(text =>
                                            <Link className='thm-btn' to={`/featurestext-edit/${text._id}`}> Update Now</Link>
                                        )}
                                    </>
                                }
                                    ...
                                    <form class="contact-form " onSubmit={handleFeaturesTextSection}>
                                        <div class="row">
                                            ...
                                            <div class="slider-btn">
                                                <button className="thm-btn" data-animation="fadeInRight" data-delay=".8s"> Add Features Text </button>
                                            </div>
                                        </div>
                                ...
                                <form class="contact-form " onSubmit={handleItemSection}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button className="thm-btn" data-delay=".8s"> Add Features Item</button>
                                        </div>
                                    </div>
                                ...
                                featureitems.map(s => <div className="col-md-6 col-lg-4">
                                    <div className="feature-card wow fadeInUp">
                                        ...
                                        <div className="feature-card_content">
                                            ...
                                            <Link to={`/edit-feature-items/${s._id}`}><h3 className="box-title" className="thm-btn">Edit Now</h3></Link>
