                                ...
                                pricing.map(b => b.packageName === 'Basic' && <div className="col-lg-4 pb-70">
                                    <div className="pricing-item-single">
                                        ...
                                        <div className="pricing-item-list ">
                                            ...
                                            <Link to={`/order-now/${b._id}`} className="thm-btn">{b.packageButtonText} <i className="envy envy-right-arrow" /></Link>
                                    ...
                                    <div className="col-lg-4 pb-70">
                                        <div className="pricing-item-single">
                                            ...
                                            <div className="pricing-item-list">
                                                ...
                                                <Link to={`/order-now/${s._id}`} className="thm-btn">{s.packageButtonText} <i className="envy envy-right-arrow" /></Link>
                                ...
                                pricing.map(p => p.packageName === 'Standard' && <div className="col-lg-4 pb-70">
                                    <div className="pricing-item-single">
                                        ...
                                        <div className="pricing-item-list">
                                            ...
                                            <Link to={`/order-now/${p._id}`} className="thm-btn">{p.packageButtonText} <i className="envy envy-right-arrow" /></Link>
