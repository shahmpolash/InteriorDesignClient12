...
const WorkStep = () => {
    ...
    useEffect(() => {
        fetch(`https://interiordesignseoclone-610277fa395f.herokuapp.com/worksec`)
            .then((res) => res.json())
    ...
    const handleWorkSection = (event) => {
        ...
        const url = `https://interiordesignseoclone-610277fa395f.herokuapp.com/add-worksec`;
        fetch(url, {
            method: "POST",
            headers: {
                                ...
                                <form class="contact-form " onSubmit={handleWorkSection}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button className="thm-btn" data-animation="fadeInRight" data-delay=".8s">Add Work Step</button>
                                        </div>
                                    </div>
...

                            {
                                stepwork.map(a => a.stepNumber === '01' && <div className="process-card">
                                    ...
                                    <div className="process-card_content">
                                        ...
                                        <Link to={`/edit-work/${a._id}`}><h3 className="box-title" className="thm-btn">Edit Now</h3></Link>
...

                            {
                                stepwork.map(b => b.stepNumber === '02' && <div className="process-card">
                                    ...
                                    <div className="process-card_content">
                                        ...
                                        <Link to={`/edit-work/${b._id}`}><h3 className="box-title" className="thm-btn">Edit Now</h3></Link>
...

                            {
                                stepwork.map(c => c.stepNumber === '03' && <div className="process-card">
                                    ...
                                    <div className="process-card_content">
                                        ...
                                        <Link to={`/edit-work/${c._id}`}><h3 className="box-title" className="thm-btn">Edit Now</h3></Link>
...

                            {
                                stepwork.map(d => d.stepNumber === '04' && <div className="process-card">
                                    ...
                                    <div className="process-card_content">
                                        ...
                                        <Link to={`/edit-work/${d._id}`}><h3 className="box-title" className="thm-btn">Edit Now</h3></Link>
