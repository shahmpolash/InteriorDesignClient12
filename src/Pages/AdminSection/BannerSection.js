...
const BannerSection = () => {
    ...
    const handleBannerSection = (event) => {
        ...
        const url = `https://interiordesignseoclone-610277fa395f.herokuapp.com/add-banner`;
        fetch(url, {
            method: "POST",
            headers: {
                                    ...
                                    <>
                                        {
                                            banner.map(c =>
                                                banner.map(c =>
                                                    <Link className='thm-btn' to={`/banner/${c._id}`}> Edit Banner Section</Link>)
                                            )
                                        }
                                    </>
                                }
                                    ...
                                    <form class="contact-form " onSubmit={handleBannerSection}>
                                        <div class="row">
                                            ...
                                            <div class="slider-btn">
                                                <button className="thm-btn" data-animation="fadeInRight" data-delay=".8s">Add Banner</button>
                                            </div>
                                        </div>
