...
const UpdateAboutSection = () => {
    ...
    useEffect(() => {
        fetch(`https://interiordesignseoclone-610277fa395f.herokuapp.com/about-us/${id}`)
            .then((res) => res.json())
    ...
    const handleAboutSection = (event) => {
        ...
        const url = `https://interiordesignseoclone-610277fa395f.herokuapp.com/update-about/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                            ...
                            <form class="contact-form " onSubmit={handleAboutSection}>
                                <div class="row">
                                    ...
                                    <div class="slider-btn">
                                        <button className="thm-btn" data-animation="fadeInRight" data-delay=".8s"> Update About </button>
                                    </div>
                                </div>
