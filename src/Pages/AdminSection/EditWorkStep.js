...
const EditWorkStep = () => {
    ...
    useEffect(() => {
        fetch(`https://interiordesignseoclone-610277fa395f.herokuapp.com/worksec/${id}`)
            .then((res) => res.json())
    ...
    const handleBannerSection = (event) => {
        ...
        const url = `https://interiordesignseoclone-610277fa395f.herokuapp.com/update-worksec/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                                ...
                                <form class="contact-form " onSubmit={handleBannerSection}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button className="thm-btn" data-animation="fadeInRight" data-delay=".8s">Update Work section</button>
                                        </div>
                                    </div>
