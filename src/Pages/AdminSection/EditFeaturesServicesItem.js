...
const EditFeaturesServicesItem = () => {
    ...
    useEffect(() => {
        fetch(`https://interiordesignseoclone-610277fa395f.herokuapp.com/featureitems/${id}`)
            .then((res) => res.json())
    ...
    const handleItemSection = (event) => {
        ...
        const url = `https://interiordesignseoclone-610277fa395f.herokuapp.com/update-featureitems/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                                ...
                                <form class="contact-form " onSubmit={handleItemSection}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button className="thm-btn" data-animation="fadeInRight" data-delay=".8s"> Update Feature </button>
                                        </div>
                                    </div>
