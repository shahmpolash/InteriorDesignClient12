...
const AddItem = () => {
    ...
    const handleAddItem = (event) => {
        ...
        const url = `https://interiordesignseoclone-610277fa395f.herokuapp.com/add-item`;
        fetch(url, {
            method: "POST",
            headers: {
                            ...
                            <form class="contact-form " onSubmit={handleAddItem}>
                                <div class="row">
                                    ...
                                    <div class="slider-btn">
                                        <button className="thm-btn" data-animation="fadeInRight" data-delay=".8s">Add Item</button>
                                    </div>
                                </div>
