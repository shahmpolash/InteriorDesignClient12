...
const PaypalEmail = () => {
    ...
    useEffect(() => {
        fetch(`https://interiordesignseoclone-610277fa395f.herokuapp.com/paypal-email/${id}`)
            .then((res) => res.json())
    ...
    const handleUpdatePaypal = (event) => {
        ...
        const url = `https://interiordesignseoclone-610277fa395f.herokuapp.com/paypal-email/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                            ...
                            <form class="contact-form " onSubmit={handleUpdatePaypal}>
                                <div class="row">
                                    ...
                                    <div class="slider-btn">
                                        <button className="thm-btn" data-animation="fadeInRight" data-delay=".8s"> Update Now</button>
                                    </div>
                                </div>
