...
const FooterSocial = () => {
    ...
    const handleFootersocial = (event) => {
        ...
        const url = `https://interiordesignseoclone-610277fa395f.herokuapp.com/add-footer-social`;
        fetch(url, {
            method: "POST",
            headers: {
                                    ...
                                    <>
                                        {
                                            footersocial.map(c =>
                                                footersocial.map(c =>
                                                    <Link className='thm-btn' to={`/edit-social-footer/${c._id}`}> Edit Social URL </Link>)
                                    ...
                                    <form class="contact-form " onSubmit={handleFootersocial}>
                                        <div class="row">
                                            ...
                                            <div class="slider-btn">
                                                <button className="thm-btn" data-delay=".8s"> Add Footer Social </button>
                                            </div>
                                        </div>
