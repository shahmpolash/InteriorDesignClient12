...
const UpdateVideoSection = () => {
    ...
    useEffect(() => {
        fetch(`https://interiordesignseoclone-610277fa395f.herokuapp.com/videos-items/${id}`)
            .then((res) => res.json())
    ...
    const handleVideoSection = (event) => {
        ...
        const url = `https://interiordesignseoclone-610277fa395f.herokuapp.com/videos-items/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
