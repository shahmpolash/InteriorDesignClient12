...
const EditMainService = () => {
    ...
    useEffect(() => {
        fetch(`https://interiordesignseoclone-610277fa395f.herokuapp.com/service-item/${id}`)
            .then((res) => res.json())
    ...
    const handleAddItem = (event) => {
        ...
        const url = `https://interiordesignseoclone-610277fa395f.herokuapp.com/service-item/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
            ...
            <form class="contact-form" onSubmit={handleAddItem}>
                <div class="row">
                    ...
                    <div class="slider-btn">
                        <button className="thm-btn" data-animation="fadeInRight" data-delay=".8s"> Update Main service </button>
                    </div>
                </div>
