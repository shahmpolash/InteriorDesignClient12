...
const EditServicestext = () => {
    ...
    useEffect(() => {
        fetch(`https://interiordesignseoclone-610277fa395f.herokuapp.com/service/${id}`)
            .then((res) => res.json())
    ...
    const handleServiceText = (event) => {
        ...
        const url = `https://interiordesignseoclone-610277fa395f.herokuapp.com/service/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                                    ...
                                    <div class="row">
                                        ...
                                        <div className="col-lg-12 col-md-12 mb-3">
                                         ...
                                         <div class="slider-btn">
                                            <button className="thm-btn" data-animation="fadeInRight" data-delay=".8s"> Update Services Text</button>
                                        </div>
                                    </div>
