...
const EditFooterCopyright = () => {
    ...
    useEffect(() => {
        fetch(`https://interiordesignseoclone-610277fa395f.herokuapp.com/copyrights/${id}`)
            .then((res) => res.json())
    ...
    const handleFooterCopyright = (event) => {
        ...
        const url = `https://interiordesignseoclone-610277fa395f.herokuapp.com/copyrights/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
