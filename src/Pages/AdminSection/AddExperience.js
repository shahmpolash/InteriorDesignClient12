...
const AddExperience = () => {
    ...
    useEffect(() => {
        fetch(`https://interiordesignseoclone-610277fa395f.herokuapp.com/experiences`)
            .then((res) => res.json())
    ...
    const handleExperienceSection = (event) => {
        ...
        const url = `https://interiordesignseoclone-610277fa395f.herokuapp.com/add-experience`;
        fetch(url, {
            method: "POST",
            headers: {
                        ...
                        <div class="col-lg-8 col-md-12">
...

                            {
                                ...
                                <>
                                    {
                                        exprience.map(a =>
                                            <Link className='thm-btn' to={`/edit-experience/${a._id}`}>
                                ...
                                <form class="contact-form " onSubmit={handleExperienceSection}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button className="thm-btn" data-animation="fadeInRight" data-delay=".8s"> Update Experience </button>
                                        </div>
                                    </div>
