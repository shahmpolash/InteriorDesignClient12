...
const ServicesSection = () => {
    ...
    const handleServiceSection = (event) => {
        ...
        const url = `https://interiordesignseoclone-610277fa395f.herokuapp.com/add-Service`;
        fetch(url, {
            method: "POST",
            headers: {
    ...
    const handleAddItem = (event) => {
        ...
        const url = `https://interiordesignseoclone-610277fa395f.herokuapp.com/add-service-item`;
        fetch(url, {
            method: "POST",
            headers: {
                "content-type": "application/json",
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-12">
                            <h2 className='mt-5'> Update Service Text </h2>
                            {
                                service.length === 1 &&
                                <> {
                                    service.map(s => <Link className='thm-btn' to={`/servicetext-edit/${s._id}`}>Update Service</Link>)
                                }</>
                                ...
                                <form class="contact-form " onSubmit={handleServiceSection}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button className="thm-btn" data-animation="fadeInRight" data-delay=".8s"> Update Services </button>
                                        </div>
                                    </div>
                            ...
                            <form class="contact-form" onSubmit={handleAddItem}>
                                <div class="row">
                                    ...
                                    <div class="slider-btn">
                                        <button className="thm-btn" data-animation="fadeInRight" data-delay=".8s"> Add Service </button>
                                    </div>
                                </div>
        ...
        <div className="course_card style_2">
          ...
          <div className="item_content">
            ...
            <h5 className="item_title">
              ...
              <Link to={`/service-edit/${s._id}`} className='thm-btn  mt-2 mb-2'>Edit Services</Link>
              </a>
            </h5>
