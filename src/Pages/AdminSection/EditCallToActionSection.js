...
const EditCallToActionSection = () => {
    ...
    useEffect(() => {
        fetch(`https://interiordesignseoclone-610277fa395f.herokuapp.com/actions/${id}`)
            .then((res) => res.json())
    ...
    const handleActionSection = (event) => {
        ...
        const url = `https://interiordesignseoclone-610277fa395f.herokuapp.com/update-actions/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                                ...
                                <form class="contact-form " onSubmit={handleActionSection}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button className="thm-btn" data-animation="fadeInRight" data-delay=".8s">Update Action</button>
                                        </div>
                                    </div>
