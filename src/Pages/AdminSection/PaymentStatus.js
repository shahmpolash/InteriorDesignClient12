...
const PaymentStatus = () => {
    ...
    const handlePaymentStatus = (event) => {
        ...
        const url = `https://interiordesignseoclone-610277fa395f.herokuapp.com/order/${order._id}`;
        fetch(url, {
            method: "PUT",
            headers: {
    ...
    const handleOrderStatus = (event) => {
        ...
        const url = `https://interiordesignseoclone-610277fa395f.herokuapp.com/order-status/${order._id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                "content-type": "application/json",
                ...
                <div className='text-center'> {/* Center-align the content */}
                    ...
                    <form onSubmit={handlePaymentStatus} className="text-center"> {/* Center-align the form */}
                        ...
                        <div class="slider-btn">
                            <button class="thm-btn mt-3" data-animation="fadeInRight" data-delay=".8s"> Update Payment </button>
                        </div>
                    </form>
                    ...
                    <form onSubmit={handleOrderStatus} className="text-center"> {/* Center-align the form */}
                        ...
                        <div class="slider-btn">
                            <button class="thm-btn mt-3" data-animation="fadeInRight" data-delay=".8s"> Update Order </button>
                        </div>
                    </form>
