...
const EditTeamMemberText = () => {
    ...
    useEffect(() => {
        fetch(`https://interiordesignseoclone-610277fa395f.herokuapp.com/teamstext/${id}`)
            .then((res) => res.json())
    ...
    const handleTeamTextSection = (event) => {
        ...
        const url = `https://interiordesignseoclone-610277fa395f.herokuapp.com/teamstext/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                        ...
                        <form class="contact-form " onSubmit={handleTeamTextSection}>
                            <div class="row">
                                ...
                                <div class="slider-btn">
                                    <button className="thm-btn" data-animation="fadeInRight" data-delay=".8s"> Update Team Member Text </button>
                                </div>
                            </div>
