...
const EditFAQitem = () => {
    ...
    useEffect(() => {
        fetch(`https://interiordesignseoclone-610277fa395f.herokuapp.com/faq-item/${id}`)
            .then((res) => res.json())
    ...
    const handleAddItem = (event) => {
        ...
        const url = `https://interiordesignseoclone-610277fa395f.herokuapp.com/faq-item/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
            ...
            <form class="contact-form" onSubmit={handleAddItem}>
                <div class="row">
                    ...
                    <div class="slider-btn">
                        <button className="thm-btn" data-animation="fadeInRight"  data-delay=".8s"> FAQ Update </button>
                    </div>
                </div>
