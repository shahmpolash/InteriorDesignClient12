...
const FooterAbout = () => {
    ...
    useEffect(() => {
        fetch(`https://interiordesignseoclone-610277fa395f.herokuapp.com/footer-about`)
            .then((res) => res.json())
    ...
    const handleFooterAbout = (event) => {
        ...
        const url = `https://interiordesignseoclone-610277fa395f.herokuapp.com/add-footer-about`;
        fetch(url, {
            method: "POST",
            headers: {
