...
const EditVideoText = () => {
    ...
    useEffect(() => {
        fetch(`https://interiordesignseoclone-610277fa395f.herokuapp.com/videos/${id}`)
            .then((res) => res.json())
    ...
    const handleVideoText = (event) => {
        ...
        const url = `https://interiordesignseoclone-610277fa395f.herokuapp.com/update-videos/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                                ...
                                <form class="contact-form " onSubmit={handleVideoText}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button className="thm-btn" data-animation="fadeInRight" data-delay=".8s"> Update Video Text</button>
                                        </div>
                                    </div>
