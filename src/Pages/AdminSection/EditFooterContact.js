...
const EditFooterContact = () => {
    ...
    useEffect(() => {
        fetch(`https://interiordesignseoclone-610277fa395f.herokuapp.com/footer-address/${id}`)
            .then((res) => res.json())
    ...
    const handlefooterAddress = (event) => {
        ...
        const url = `https://interiordesignseoclone-610277fa395f.herokuapp.com/footer-address/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
                            ...
                            <form class="contact-form " onSubmit={handlefooterAddress}>
                                <div class="row">
                                    ...
                                    <div class="slider-btn">
                                        <button className="thm-btn" data-delay=".8s"> Update Address Details</button>
                                    </div>
                                </div>
