...
const ContactPage = () => {
    ...
    useEffect(() => {
        fetch(`https://interiordesignseoclone-610277fa395f.herokuapp.com/contacts`)
            .then((res) => res.json())
    ...
    const handleContactSection = (event) => {
        ...
        const url = `https://interiordesignseoclone-610277fa395f.herokuapp.com/add-contact`;
        fetch(url, {
            method: "POST",
            headers: {
                            ...
                            <form class="contact-form " onSubmit={handleContactSection}>
                                <div class="row">
                                    ...
                                    <div class="slider-btn">
                                        <button className="thm-btn" data-delay=".8s"> Add Contcat Details</button>
                                    </div>
                                </div>
