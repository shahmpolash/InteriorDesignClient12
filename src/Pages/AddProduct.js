...
const AddProduct = () => {
  ...
  useEffect(() => {
    fetch(`https://interiordesignseoclone-610277fa395f.herokuapp.com/products-variation`)
      .then((res) => res.json())
      .then((info) => setVariations(info));
  }, []);
  useEffect(() => {
    fetch(`https://interiordesignseoclone-610277fa395f.herokuapp.com/categories`)
      .then((res) => res.json())
  ...
  const handleAddProduct = (event) => {
    ...
    const url = `https://interiordesignseoclone-610277fa395f.herokuapp.com/add-product`;
    fetch(url, {
      method: "POST",
      headers: {
