...
const PlaceOrder = () => {
  ...
  useEffect(() => {
    fetch(`https://interiordesignseoclone-610277fa395f.herokuapp.com/cash-on-delivery`)
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch(`https://interiordesignseoclone-610277fa395f.herokuapp.com/payment-accounts`)
      .then((res) => res.json())
  ...
  const handlePlaceOrder = (event) => {
    ...
    const url = `https://interiordesignseoclone-610277fa395f.herokuapp.com/new-order`;
    fetch(url, {
      method: "POST",
      headers: {
  ...
  const handlePlaceOrderCashOnDelivery = (event) => {
    ...
    const url = `https://interiordesignseoclone-610277fa395f.herokuapp.com/new-order-cash-on-delivery`;
    fetch(url, {
      method: "POST",
      headers: {
        "content-type": "application/json",
